...
export default function Home() {
  ...
  return (
    <>
      <header className="bg-black shadow-md py-2">
        <div className="container mx-auto flex justify-between items-center px-4">
          <div className="flex items-center">
            <h1 className="ml-2 text-xl font-serif font-thin">TANN TRIM</h1>
          </div>
          <ul className="flex space-x-6 cursor-pointer">
            <li>
              <svg
                ...
                <path
                  d="M20.8945 20.1953C20.9648 20.2656 21 20.3711 21 20.4766C21 20.6172 20.9648 20.7227 20.8945 20.793L20.543 21.1094C20.4375 21.2148 20.332 21.25 20.2266 21.25C20.0859 21.25 20.0156 21.2148 19.9453 21.1094L15.4102 16.5742C15.3047 16.5039 15.2695 16.4336 15.2695 16.293V15.9414C14.6016 16.5742 13.8281 17.0312 12.9844 17.3828C12.1406 17.7344 11.2266 17.875 10.3125 17.875C8.97656 17.875 7.74609 17.5586 6.62109 16.8906C5.49609 16.2578 4.61719 15.3789 3.98438 14.2539C3.31641 13.1289 3 11.8984 3 10.5625C3 9.22656 3.31641 8.03125 3.98438 6.90625C4.61719 5.78125 5.49609 4.90234 6.62109 4.23438C7.74609 3.60156 8.97656 3.25 10.3125 3.25C11.6484 3.25 12.8438 3.60156 13.9688 4.23438C15.0938 4.90234 15.9727 5.78125 16.6406 6.90625C17.2734 8.03125 17.625 9.22656 17.625 10.5625C17.625 11.5117 17.4492 12.4258 17.0977 13.2695C16.7461 14.1133 16.2891 14.8867 15.6914 15.5195H16.043C16.1484 15.5195 16.2539 15.5898 16.3594 15.6602L20.8945 20.1953ZM10.3125 16.75C11.4375 16.75 12.457 16.5039 13.4062 15.9414C14.3555 15.3789 15.0938 14.6406 15.6562 13.6914C16.2188 12.7422 16.5 11.6875 16.5 10.5625C16.5 9.4375 16.2188 8.41797 15.6562 7.46875C15.0938 6.51953 14.3555 5.78125 13.4062 5.21875C12.457 4.65625 11.4375 4.375 10.3125 4.375C9.1875 4.375 8.13281 4.65625 7.18359 5.21875C6.23438 5.78125 5.49609 6.51953 4.93359 7.46875C4.37109 8.41797 4.125 9.4375 4.125 10.5625C4.125 11.6875 4.37109 12.7422 4.93359 13.6914C5.49609 14.6406 6.23438 15.3789 7.18359 15.9414C8.13281 16.5039 9.1875 16.75 10.3125 16.75Z"
                  fill="#E5DFD9"
                />
              </svg>
            </li>
            ...
            <li>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M17.0625 3.25C17.5195 3.25 17.9062 3.42578 18.2578 3.74219C18.5742 4.09375 18.75 4.48047 18.75 4.9375V21.25L12 17.3125L5.25 21.25V4.9375C5.25 4.48047 5.39062 4.09375 5.74219 3.74219C6.05859 3.42578 6.44531 3.25 6.9375 3.25H17.0625ZM17.625 19.2812V4.9375C17.625 4.79688 17.5547 4.65625 17.4492 4.55078C17.3438 4.44531 17.2031 4.375 17.0625 4.375H6.9375C6.76172 4.375 6.62109 4.44531 6.51562 4.55078C6.41016 4.65625 6.375 4.79688 6.375 4.9375V19.2812L12 16.0117L17.625 19.2812Z"
                  fill="#E5DFD9"
                />
              </svg>
            </li>{" "}
            <li>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M16.5 7.75H19.875V18.4375C19.875 19.2109 19.5938 19.8789 19.0312 20.4414C18.4688 21.0039 17.8359 21.25 17.0625 21.25H6.9375C6.16406 21.25 5.49609 21.0039 4.93359 20.4414C4.37109 19.8789 4.125 19.2109 4.125 18.4375V7.75H7.5C7.5 6.94141 7.67578 6.20312 8.09766 5.5C8.48438 4.79688 9.01172 4.26953 9.71484 3.84766C10.418 3.46094 11.1562 3.25 12 3.25C12.8086 3.25 13.5469 3.46094 14.25 3.84766C14.9531 4.26953 15.4805 4.79688 15.9023 5.5C16.2891 6.20312 16.5 6.94141 16.5 7.75ZM12 4.375C11.0508 4.375 10.2422 4.72656 9.60938 5.35938C8.94141 6.02734 8.625 6.83594 8.625 7.75H15.375C15.375 6.83594 15.0234 6.02734 14.3906 5.35938C13.7227 4.72656 12.9141 4.375 12 4.375ZM18.75 18.4375V8.875H16.5V10.5625C16.5 10.7383 16.4297 10.8789 16.3242 10.9844C16.2188 11.0898 16.0781 11.125 15.9375 11.125C15.7617 11.125 15.6211 11.0898 15.5156 10.9844C15.4102 10.8789 15.375 10.7383 15.375 10.5625V8.875H8.625V10.5625C8.625 10.7383 8.55469 10.8789 8.44922 10.9844C8.34375 11.0898 8.20312 11.125 8.0625 11.125C7.88672 11.125 7.74609 11.0898 7.64062 10.9844C7.53516 10.8789 7.5 10.7383 7.5 10.5625V8.875H5.25V18.4375C5.25 18.9297 5.39062 19.3164 5.74219 19.6328C6.05859 19.9844 6.44531 20.125 6.9375 20.125H17.0625C17.5195 20.125 17.9062 19.9844 18.2578 19.6328C18.5742 19.3164 18.75 18.9297 18.75 18.4375Z"
                  fill="#E5DFD9"
                />
              </svg>
            </li>
      ...
      <div className="bg-black p-3 mx-4">
      ...
      <div className="flex justify-center items-center">
        {images.map((image, index) => (
          <div
            key={index}
            className="flex justify-center w-full sm:w-1/4 lg:w-[12%] p-2 cursor-pointer">
            <Image src={image} alt={`Image ${index}`} width={96} height={130} />
          </div>
        ))}
      </div>
